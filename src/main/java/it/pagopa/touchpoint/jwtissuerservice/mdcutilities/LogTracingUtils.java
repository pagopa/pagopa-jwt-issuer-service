...
import it.pagopa.touchpoint.jwtissuerservice.mdcutilities.exception.LogTracingUtilException;
...
public class LogTracingUtils {
    ...
    /**
     * Core logging routine. Populates the MDC with attributes, details, and errors,
     * issues the log statement using the requested level, and immediately performs
     * MDC cleanup to prevent context leaks.
     *
