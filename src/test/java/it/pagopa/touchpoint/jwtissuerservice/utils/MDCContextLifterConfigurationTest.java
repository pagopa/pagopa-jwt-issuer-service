...
import it.pagopa.touchpoint.jwtissuerservice.mdcutilities.MDCContextLifterConfiguration;
...
class MDCContextLifterConfigurationTest {
    ...
    void shouldRegisterAndCleanupHook() throws Exception {
        ...
        String afterHook = Mono.just("value")
                .hide()
                .contextWrite(Context.of(JWTIssuerTracingUtils.TracingEntry.CTX_TRANSACTION_ID.getKey(), "tx-001"))
                .block();
