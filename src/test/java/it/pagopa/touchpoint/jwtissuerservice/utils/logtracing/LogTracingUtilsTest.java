package it.pagopa.touchpoint.jwtissuerservice.utils.logtracing;
...
class LogTracingUtilsTest {
    ...
    void testLogInfo_withSuccessAndAttributes() {
        ...
        attributes.put(LogTracingUtils.AttributeKeys.CTX_TRANSACTION_ID, "12345");
        // Act
    ...
    void testNullAttributeKeysAndValuesAreIgnored() {
        // Arrange
        Map<LogTracingUtils.AttributeKeys, String> attributes = new EnumMap<>(LogTracingUtils.AttributeKeys.class);
        attributes.put(LogTracingUtils.AttributeKeys.CTX_TRANSACTION_ID, null); // Null value
    ...
    void shouldEnrichContextUsingProvidedAndDefaultValues() {
        ...
        tracingEntries.put(LogTracingUtils.AttributeKeys.CTX_TRANSACTION_ID, null);
        ...
        assertEquals("{transactionId-not-found}", enrichedContext.get("ctx.transaction.id"));
    }
